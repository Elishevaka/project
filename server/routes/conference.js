    ...
    module.exports = {
        ...
        //     const { roomId, startDate, endDate, guestName, guestId, guestEmail } = req.body;

        //     // Check if required fields are present
        //     if (!roomId || !startDate || !endDate || !guestName || !guestId) {
        //         return res.status(400).json({ error: 'Room ID, start and end dates, and guest details are required.' });
        //     }
        ...
        //         // Create a new booking record for the specified dates
